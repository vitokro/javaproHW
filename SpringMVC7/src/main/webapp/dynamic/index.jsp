           ...
           <h3><img height="50" width="55" src="<c:url value="/static/logo.png"/>"/><a href="/">Contacts List</a></h3>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="groupsBtn" class="btn btn-default navbar-btn">Groups</button></li>
                            <li><button type="button" id="downloadXML" class="btn btn-default navbar-btn">Download to XML</button></li>
            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${contacts}" var="contact">
                    <tr>
                        <td><input type="checkbox" name="checked[]" value="${contact.id}" id="checkbox_${contact.id}"/></td>
                        <td>${contact.name}</td>
